...
top_10_countries_by_mean_salary_plot <- top_10_countries_by_mean_salary_data %>%
  ...
  geom_point(aes(x=lowest_salary,), color='gold3', fill='gold4', size=3, shape=21) +
  geom_point(aes(x=highest_salary), color='gold3', fill='gold4', size=3, shape=21) +
  geom_segment(aes(x=lowest_salary+7000, xend=highest_salary-7000, y=company_location, yend=company_location), color='gold3') +
