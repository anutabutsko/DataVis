...
salary_trends_plot <- salary_trends_plot_data %>%
  ...
  geom_point(shape = 23, size = 4, aes(color = work_models, fill = work_models)) +
  theme_minimal() +
  scale_y_continuous(labels=salary_label, breaks = seq(100000, 300000, 25000), limits=c(120000, 260000)) +
  scale_x_continuous(position='top') +
  scale_color_manual(values = c("Remote" = "plum3", "On-site" = "turquoise3", "Hybrid" = "gold3")) +
  scale_fill_manual(values = c("Remote" = "plum4", "On-site" = "turquoise4", "Hybrid" = "gold4")) +
  labs(title='Data Science Salary Trends by Work Model',
       subtitle = "For Years 2020 through 2024",
       x=NULL,
  ...
  theme(axis.text.x = element_text(size = 8), 
        ...
        plot.subtitle = element_text(color = 'white', size = 8, vjust = 2.5),
        axis.title.y = element_text(vjust=-1.2, color='turquoise4', size = 8),
