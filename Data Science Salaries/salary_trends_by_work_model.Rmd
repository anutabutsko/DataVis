...
salary_trends_plot <- salary_trends_plot_data %>%
  ...
  theme_minimal() +
  scale_y_continuous(labels=salary_label, breaks = seq(100000, 300000, 25000), limits=c(100000, 225000)) +
  scale_x_continuous(position='top') +
  scale_color_manual(values = c("On-site" = "turquoise3", "Hybrid" = "gold3", "Remote" = "plum3")) +
  scale_fill_manual(values = c("On-site" = "turquoise4", "Hybrid" = "gold4", "Remote" = "plum4")) +
